...
# Modifiable params
iteration_id <- "douse_0017"
initial_seed <- 1057817
grid_width <- 10
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
# Gradient colours
base_colours <- c("#3E517A", "#4D86A5")
gradient_source1 <- c(base_colours, "#12E2F1", "#CF0BF1", "#D60B2D")
gradient_source2 <- c(base_colours, "#98DA1F", "#C3C4E9")
gradient_source3 <- c(base_colours, "#FC9F5B", "#9CC76D")
