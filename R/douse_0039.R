...
# Modifiable params
iteration_id <- "douse_0039"
initial_seed <- 1057839
grid_width <- 5
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
gradient_source1 <- c(base_colours, "#E47F75", "#05A8AA", "#FA7B06")
gradient_source2 <- c(base_colours, "#F44708", "#985565")
gradient_source3 <- c(base_colours, "#FFAE03", "#3C63C1")
...
ggplot2::ggsave(
  ...
  plots_in_grid, width = 1000, height = 200, units = "px",
