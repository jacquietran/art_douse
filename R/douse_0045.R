...
# Modifiable params
iteration_id <- "douse_0045"
initial_seed <- 1057845
grid_width <- 5
grid_height <- 2
plot_bg <- "#131313"
plot_res <- 100
...
# Gradient colours
base_colours <- c("#F7BC50", "#724562")
gradient_source1 <- c(base_colours, "#4A5B8A", "#8C403A", "#B6AED5")
gradient_source2 <- c(base_colours, "#FB4D0E", "#DE3F67", "#1C143E")
gradient_source3 <- c(base_colours, "#B6AED5", "#EB7E5C", "#7D2A53")
...
ggplot2::ggsave(
  ...
  plots_in_grid, width = 1000, height = 400, units = "px",
