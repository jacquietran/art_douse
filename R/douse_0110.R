...
# Gradient colours
gradient_colours <- c("#26532B", "#EF476F", "#5ABCB9", "#FFD166", "#6461A0")
...
set.seed(initial_seed)
adjust_factor <- sample(seq(0.75, 1.5, by = 0.1), 1)

# Line size for 2D density plots
# set.seed(initial_seed)
# line_size <- sample(seq(0.1, 0.3, by = 0.1), 1)
line_size <- 0.1
