...
# Modifiable params
iteration_id <- "douse_0027"
initial_seed <- 1057827
grid_width <- 10
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
# Gradient colours
base_colours <- c("#D5CA7A", "#66B76A", "#437039")
gradient_source1 <- c(base_colours, "#EFB337", "#A24307", "#0F492F")
gradient_source2 <- c(base_colours, "#8E1916", "#47926A")
gradient_source3 <- c(base_colours, "#DD8024", "#B8191B")
