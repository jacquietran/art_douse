...
# Modifiable params
iteration_id <- "douse_0012"
initial_seed <- 1057812
grid_width <- 10
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
# Gradient colours
base_colours <- c("#73B7B8", "#52A1A3", "#76C8B1", "#50B99B")
gradient_source1 <- c(base_colours, "#DC244B", "#F6CB52")
gradient_source2 <- c(base_colours, "#F05A29", "#AF1D3C")
