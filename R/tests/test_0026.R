...
gradient_source1 <- c(base_colours, "#E05149", "#F59700")
gradient_source2 <- c(base_colours, "#E77973", "#FBC260", "#8BC6CC")
gradient_source3 <- c(base_colours, "#8BC6CC", "#51AFB9")
