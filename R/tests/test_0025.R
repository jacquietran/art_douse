...
# Gradient colours
base_colours <- c("#1697A6", "#0E606B")
gradient_source1 <- c(base_colours, "#CB322A", "#F47068", "#FFB3AE")
gradient_source2 <- c(base_colours, "#F59700", "#FAB338", "#FFD685")
gradient_source3 <- c(base_colours, "#17494F", "#13282A")
