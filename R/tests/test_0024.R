...
# Gradient colours
base_colours <- c("#355070", "#6D597A", "#B56576")
gradient_source1 <- c(base_colours, "#FFC759", "#C0B051", "#A0A44D")
gradient_source2 <- c(base_colours, "#75DDDD", "#3FCDB4", "#24C59F")
gradient_source3 <- c(base_colours, "#E56B6F", "#E88C7D", "#EAAC8B")
