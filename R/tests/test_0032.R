...
# Gradient colours
base_colours <- c("#faedcd", "#d4a373")
gradient_source1 <- c(base_colours, "#F26418", "#F9844A", "#FBC489")
gradient_source2 <- c(base_colours, "#C68B80", "#E09A7D", "#F39C6B")
gradient_source3 <- c(base_colours, "#C68B80", "#E09A7D", "#F39C6B")
