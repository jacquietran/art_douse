...
# Gradient colours
gradient_source1 <- c("#5FBFA2", "#478583", "#F26418", "#F9844A", "#FBC489")
gradient_source2 <- c("#5FBFA2", "#478583", "#C68B80", "#E09A7D", "#F39C6B")
gradient_source3 <- c("#F26418", "#F9844A", "#FBC489", "#C68B80", "#E09A7D", "#F39C6B")
