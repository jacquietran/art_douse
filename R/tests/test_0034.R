...
# Gradient colours
base_colours <- c("#D1CBC7", "#828FA6", "#335284")
gradient_source1 <- c(base_colours, "#B96427", "#C67A2F", "#D79847")
gradient_source2 <- c(base_colours, "#C33149", "#D16174", "#DF909D")
gradient_source3 <- c(base_colours, "#3C5967", "#628393", "#869FAC")
...
ggplot2::ggsave(
  ...
  plots_in_grid, width = 200, height = 2000, units = "px",
