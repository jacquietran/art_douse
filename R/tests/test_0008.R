...
#######################################
density_plot <- function(data, palette, rounded = c(TRUE, FALSE), resolution){
...
gridded_plots <- function(
  data, palette_list, bg_colour, n_cols, n_rows, rounded, resolution){
