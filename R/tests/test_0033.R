...
# Gradient colours
base_colours <- paletteer::paletteer_d("ochRe::mccrea")[2:4]
gradient_source1 <- c(base_colours, paletteer::paletteer_d("ochRe::mccrea")[5:7])
gradient_source2 <- c(base_colours, paletteer::paletteer_d("ochRe::mccrea")[8:11])
gradient_source3 <- c(base_colours, paletteer::paletteer_d("ochRe::mccrea")[1])
