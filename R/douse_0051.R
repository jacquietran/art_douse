...
# Modifiable params
iteration_id <- "douse_0051"
initial_seed <- 1057851
grid_width <- 10
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
# Gradient colours
base_colours <- c("#18132A", "#350066")
gradient_source1 <- c(base_colours, "#1C3580", "#F20089", "#ECE8ED")
gradient_source2 <- c(base_colours, "#7DB5A9", "#F94F54")
gradient_source3 <- c(base_colours, "#2A9134", "#C18698", "#0E5737")
