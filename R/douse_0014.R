...
# Modifiable params
iteration_id <- "douse_0014"
initial_seed <- 1057814
grid_width <- 10
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
# Gradient colours
base_colours <- c("#73B7B8", "#52A1A3")
gradient_source1 <- c(base_colours, "#50B99B", "#DC244B", "#F6CB52")
gradient_source2 <- c(base_colours, "#76C8B1", "#F05A29", "#AF1D3C")
gradient_source3 <- c(base_colours, "#F3B816", "#D23F0F")
...
img_blended <- magick::image_flatten(
  c(img_filtered, img_dust_diff), "LinearDodge")
